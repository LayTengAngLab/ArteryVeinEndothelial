...
saveRDS(alldata, file = "/home/rstudio/arteryvein2022.rds")
...
citation = list(
  ...
  title   = "Generating human artery and vein cells from pluripotent stem cells
...
highlights the arterial tropism of Nipah and Hendra viruses",shiny.dir = "/users/stanfordkevin/Downloads/arteryveinscRNA/", shiny.footnotes = citation,default.gene1 = "CDH5", default.gene2 = "SOX17",default.multigene = c("CXCR4","EFNB2","DLL4", "UNC5B", "APLN","NR2F2","FLRT2","NT5E","APLNR")) 
